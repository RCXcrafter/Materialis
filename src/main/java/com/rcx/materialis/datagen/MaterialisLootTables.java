...
public class MaterialisLootTables extends LootTableProvider {
	...
	private final List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootParameterSet>> lootTables = ImmutableList.of(Pair.of(MaterialisBlockLootTables::new, LootParameterSets.BLOCK));
