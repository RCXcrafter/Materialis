...
public class ColorizerModifierRecipeBuilder extends AbstractModifierRecipeBuilder<ColorizerModifierRecipeBuilder> {

	private final List<SizedIngredient> inputs = new ArrayList<>();

	protected ColorizerModifierRecipeBuilder(ModifierEntry result) {
		super(result);
	}
	 ...
	 */
	public static ColorizerModifierRecipeBuilder modifier(ModifierEntry modifier) {
		return new ColorizerModifierRecipeBuilder(modifier);
	}
	 ...
	 */
	public static ColorizerModifierRecipeBuilder modifier(Modifier modifier) {
	 ...
	 */
	public ColorizerModifierRecipeBuilder addInput(SizedIngredient ingredient) {
	 ...
	 * @return  Builder instance
	 */
	public ColorizerModifierRecipeBuilder addInput(IItemProvider item, int amount) {
	 ...
	 * @return  Builder instance
	 */
	public ColorizerModifierRecipeBuilder addInput(IItemProvider item) {
	 ...
	 * @return  Builder instance
	 */
	public ColorizerModifierRecipeBuilder addInput(ITag<Item> tag, int amount) {
	 ...
	 * @return  Builder instance
	 */
	public ColorizerModifierRecipeBuilder addInput(ITag<Item> tag) {
	...
	@Override
	public ColorizerModifierRecipeBuilder buildSalvage(Consumer<IFinishedRecipe> arg0, ResourceLocation arg1) {
