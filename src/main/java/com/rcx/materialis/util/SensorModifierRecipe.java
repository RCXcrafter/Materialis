...
public class SensorModifierRecipe extends ModifierRecipe {

	boolean enabled = ModList.get().isLoaded("psi");

	private final List<SizedIngredient> inputs;

	public SensorModifierRecipe(ResourceLocation id, List<SizedIngredient> inputs, Ingredient toolRequirement, ModifierMatch requirements, String requirementsError, ModifierEntry result, int maxLevel, @Nullable SlotCount slots) {
	...
	public static class Serializer extends AbstractModifierRecipe.Serializer<SensorModifierRecipe> {
		...
		@Override
		public SensorModifierRecipe read(ResourceLocation id, JsonObject json, Ingredient toolRequirement, ModifierMatch requirements,
				String requirementsError, ModifierEntry result, int maxLevel, @Nullable SlotCount slots) {
			List<SizedIngredient> ingredients = JsonHelper.parseList(json, "inputs", SizedIngredient::deserialize);
			return new SensorModifierRecipe(id, ingredients, toolRequirement, requirements, requirementsError, result, maxLevel, slots);
		}
		...
		public SensorModifierRecipe read(ResourceLocation id, PacketBuffer buffer, Ingredient toolRequirement, ModifierMatch requirements, String requirementsError, ModifierEntry result, int maxLevel, @Nullable SlotCount slots) {
			...
			return new SensorModifierRecipe(id, builder.build(), toolRequirement, requirements, requirementsError, result, maxLevel, slots);
		}
